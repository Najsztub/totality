...
public class TestConsumption {
	...
	public static void main(String[] args) {
		...
		for (double budget : new double[] { 0, 1, 2, 4, 8 }) {
			...
			System.out.println("Quants for budget: " + budget + ": " + printArray(quants));
		...
		// Time system utility
		System.out.println("\nTest Stone Geary Utility function for time");
		...
		System.out.println("Quants for budget: " + 24 + ": " + printArray(quants));
