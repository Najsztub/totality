...
public class HHView extends JFrame {
	...
	public HHView() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(textArea, GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						.addComponent(textArea, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE).addGap(13)
	...
	class HHDesc extends AbstractTableModel {
		...
		private String[] columnNames = new String[] { "id", "Sex", "Age", "Partner", "pLife", "Income", "Cons",
				"Utility" };
		private Object[][] data = {};
