...
public class SimGUI extends JFrame {
	...
	private SimGUI() {
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lblNoHhs).addComponent(lblHhs,
				...
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnHhExplorer)
		 ...
		 * trace2.addPoint(i, (float) sumArr(popul.getAges()) / popul.nPeople());
		 * popul.step(); }
		 */
		// Make it visible:
		// Create a frame.
