...
public class SimGUI extends JFrame {
	...
	gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
		...
		.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
			.addGroup(gl_panel.createSequentialGroup().addComponent(lblNoHhs)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(lblHhs, GroupLayout.PREFERRED_SIZE, 112, GroupLayout.PREFERRED_SIZE))
			.addGroup(gl_panel.createSequentialGroup().addComponent(lblGov)
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblGovBal))
			.addGroup(gl_panel.createSequentialGroup().addComponent(btnKill)
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(fieldKill,
					GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
					GroupLayout.PREFERRED_SIZE))
			.addGroup(gl_panel.createSequentialGroup().addComponent(btnSimulate)
	...
	gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
		.addGroup(gl_panel.createSequentialGroup().addContainerGap()
			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lblNoHhs)
				.addComponent(lblHhs, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
		.addGap(3)
		.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lblGov).addComponent(lblGovBal))
		.addPreferredGap(ComponentPlacement.RELATED)
		.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
			.addComponent(fieldKill, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE)
			.addComponent(btnKill))
		.addGap(9)
		.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(btnSimulate)
			.addComponent(btnReset)).addPreferredGap(ComponentPlacement.RELATED).addComponent(btnHhExplorer)
	...
	table.getModel().addTableModelListener(new TableModelListener() {
		...
		if (column == 1) {
		    popul.getParamsOut().setParamByID(Double.parseDouble(data), row);
		}
